...
export default function HomePage() {
  return <>
    <main>
      ...
      <section className="bg-surface py-16 tablet:py-24" id="contact"><Container><div className="bg-[#1e211f] px-6 py-10 text-[#fbfaf7] tablet:px-12 tablet:py-12"><h2 className="font-display text-4xl leading-tight tablet:text-5xl">Обсудим ваш будущий проект</h2><p className="mt-5 max-w-3xl leading-7 text-[#d7d3ca]">Расскажите о пространстве, сроках и задаче — в ответ получите ориентир по формату работы и следующий шаг.</p><div className="mt-6"><ContactForm triggerClassName="bg-transparent px-0 text-[#fbfaf7] hover:bg-transparent hover:text-action" triggerLabel="Обсудить проект →" /></div></div></Container></section>
    </main>
    <SiteFooter />
  </>;
}
